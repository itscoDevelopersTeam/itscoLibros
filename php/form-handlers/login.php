...
if($resultSet = $crudUsuario->exists($userobj)) {
	...
	header("Location: http://localhost:80/itscoLibros/administracion.php");
}
else{
	header("Location: http://localhost:80/itscoLibros/index.php?mensaje=Sus datos no son válidos");
}
 ?>